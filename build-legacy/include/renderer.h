...
void updateUniformLocations(GLuint shaderProgram, GLint& millisLoc, GLint& backgroundLoc, 
                           ...
                           GLint& aspectLoc, GLint& centreLoc, GLint& tLoc);
...
SDL_GL_SetAttribute(SDL_GL_CONTEXT_MAJOR_VERSION, 3); // At least OpenGL 3.3 for ES 3.0 compatibility
...
if (!glContext) {
    ...
    if (!glContext) {
        std::cerr << "Fallback OpenGL context could not be created! SDL_Error: " << SDL_GetError() << std::endl;
...
std::cout << "Uniform locations - aspect: " << aspectLoc 
          << ", centre: " << centreLoc 
          << ", t: " << tLoc 
          << ", image: " << imageLoc << std::endl;
    ...
    while (SDL_PollEvent(&e) != 0) {
        ...
        // Handle mouse clicks
            ...
            if (e.button.button == SDL_BUTTON_LEFT) {
                ...
                std::cout << "Mouse clicked at: " << clickX << ", " << clickY 
                          << " at time: " << clickTime << "s" << std::endl;
            }
        }
